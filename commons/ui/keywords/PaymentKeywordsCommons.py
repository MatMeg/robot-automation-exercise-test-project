...
class PaymentKeywordsCommons:
    ...
    def confirm_card_payment(self, card:dict):
        ...
        self._payment_object.input_card_number_on_payment(card['number'])
        self._payment_object.log('Input card cvv')
        self._payment_object.input_card_cvv_on_payment(card['cvv'])
        self._payment_object.log('Input card expiration month')
        self._payment_object.input_card_expiration_month_on_payment(card['expiration']['MM'])
        self._payment_object.log('Input card expiration year')
        self._payment_object.input_card_year_on_payment(card['expiration']['YYYY'])
